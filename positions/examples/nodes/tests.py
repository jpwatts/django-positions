...
class NodesTestCase(TestCase):
    ...
    def test_structure(self):
        ...
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 2', 0), ('Child 1', 1), ('Child 3', 2), ('Child 4', 0), ('Child 5', 1), ('Child 6', 2)]
    ...
    def test_collection_field_change_sibling_position(self):
        ...
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 2', 0), ('Child 1', 1), ('Child 3', 2), ('Child 6', 0), ('Child 4', 1), ('Child 5', 2)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_collection_field_change_first_child(self):
        ...
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 1', 0), ('Child 3', 1), ('Child 2', 0), ('Child 4', 1), ('Child 5', 2), ('Child 6', 3)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_collection_field_change_last_child(self):
        ...
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 1', 0), ('Child 3', 1), ('Child 4', 0), ('Child 5', 1), ('Child 6', 2), ('Child 2', 3)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_collection_field_change_sibling_1(self):
        ...
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 1', 0), ('Child 3', 1), ('Child 4', 0), ('Child 2', 1), ('Child 5', 2), ('Child 6', 3)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_collection_field_change_sibling_2(self):
        ...
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 1', 0), ('Child 3', 1), ('Child 4', 0), ('Child 5', 1), ('Child 2', 2), ('Child 6', 3)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_deletion_1(self):
        ...
        self.child2.delete()
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 1', 0), ('Child 3', 1), ('Child 4', 0), ('Child 5', 1), ('Child 6', 2)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_deletion_2(self):
        ...
        self.child3.delete()
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 2', 0), ('Child 1', 1), ('Child 4', 0), ('Child 5', 1), ('Child 6', 2)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_deletion_3(self):
        ...
        self.child1.delete()
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 1', 0), ('Parent 2', 1), ('Child 2', 0), ('Child 3', 1), ('Child 4', 0), ('Child 5', 1), ('Child 6', 2)]
        self.assertEqual(sorted(result), sorted(expected_result))
    ...
    def test_deletion_4(self):
        ...
        self.parent1.delete()
        result = list(Node.objects.order_by('parent__position', 'position').values_list('name', 'position'))
        expected_result = [('Parent 2', 0), ('Child 4', 0), ('Child 5', 1), ('Child 6', 2)]
        self.assertEqual(sorted(result), sorted(expected_result))
...
class ReorderTestCase(TestCase):
    ...
    def test_changing_parent(self):
        ...
        d = Node.objects.create(name="D", parent=a)
