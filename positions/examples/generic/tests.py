...
from .models import GenericThing
...
class GenericTestCase(TestCase):
    ...
    def test_doctests_standin(self):
        ...
        self.assertEqual(self.t2.position, 0)
        self.t1.delete()
